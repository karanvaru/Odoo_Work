...
class CertificateDetails(models.Model):
    _name = 'certificate.detail'
    _description = 'Applicant Certificate Information'

    certificate_detail_id = fields.Many2one('hr.applicant')
    ...
    attachment_ids = fields.Many2many('ir.attachment', domain=[('res_model', '=', 'certificate.detail')], string='Attachments')
    ...
    def _date_field_applicant_certificate(self):
