...
class CompanyVendorController(http.Controller):
    ...
    def individual_registration(self, timeout=15, **kwargs):
        ...
        if 'vat' in kwargs:
            ...
            if existing_partner:
                ...
                return http.request.render('rdp_it_vendor_registration_form_ev17_custom.Vendor_Enquiry_Form_company_gst', vals)
            else:
        ...
        return http.request.render('rdp_it_vendor_registration_form_ev17_custom.Vendor_Enquiry_Form', vals)


    @http.route('/company_registration_gst', type='http', auth='public', website=True)
    def company_registration(self, **kw):
        return http.request.render('rdp_it_vendor_registration_form_ev17_custom.Vendor_Enquiry_Form_company_gst')

    @http.route('/web_forms', type="http", auth="public", website=True)
    def le_webform(self):
        return http.request.render('rdp_it_vendor_registration_form_ev17_custom.vendor_registration_template')
    ...
    def vendor_enquiry_form(self, **kw):
        ...
        if request.httprequest.method == 'POST':
            ...
            if not error:
                ...
                if existing_contact_email and existing_contact_phone:
                    ...
                    return http.request.render('rdp_it_vendor_registration_form_ev17_custom.existing_contact_both_mail_and_phone_message')
                elif existing_contact_email:
                    # If only email already exists
                    return http.request.render('rdp_it_vendor_registration_form_ev17_custom.existing_contact_E_mail_message')
                elif existing_contact_phone:
                    # If only phone already exists
                    return http.request.render('rdp_it_vendor_registration_form_ev17_custom.existing_contact_Phone_message')
                else:
                    new_contact = False
                    ...
                    try:
                        ...
                        return http.request.render('rdp_it_vendor_registration_form_ev17_custom.vendor_registration_success', {'id': new_contact})
        ...
        return http.request.render('rdp_it_vendor_registration_form_ev17_custom.Vendor_Enquiry_Form')
