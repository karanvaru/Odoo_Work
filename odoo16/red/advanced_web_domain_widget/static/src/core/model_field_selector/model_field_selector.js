...
export class ModelFieldSelectorBits extends Component {
    setup() {
...
Object.assign(ModelFieldSelectorBits, {
    template: "advanced_web_domain_widget._ModelFieldSelectorBits",
    components: {
        Popover: ModelFieldSelectorPopoverBits,
    },
    props: {
        fieldName: String,
        resModel: String,
...
export class ModelFieldSelectorBits2 extends ModelFieldSelectorBits {}

ModelFieldSelectorBits2.components = {
    ...ModelFieldSelectorBits.components,
    Popover: ModelFieldSelectorPopoverBits2,
}