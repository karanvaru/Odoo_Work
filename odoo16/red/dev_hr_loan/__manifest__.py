...
#    hr_payroll_account
    'data': [
        ...
        'wizard/loan_approval.xml',
        'wizard/dep_manager_loan_approval.xml',
        'wizard/hr_manager_loan_approval.xml',
        'wizard/cfo_loan_approval.xml',
        'wizard/super_approver_loan_approval.xml',
        'wizard/loan_rejection.xml',
        'wizard/dep_manager_loan_rejection.xml',
        'wizard/hr_manager_loan_rejection.xml',
        'wizard/cfo_loan_rejection.xml',
        'wizard/super_approver_loan_rejection.xml',
        'views/hr_loan_view.xml',
        # 'views/loan_setting.xml',
