...
class AccountJournal(models.Model):
    ...
    default_account_id = fields.Many2one(
        ...
        domain="[('deprecated', '=', False), ('company_id', '=', company_id),"
               "'|', ('account_type', '=', default_account_type), ('account_type', 'not in', ('asset_receivable', 'liability_payable')), '|',('branch_id', '=', branch_id), ('branch_id', '=', False)]]")
    ...
    suspense_account_id = fields.Many2one(
        ...
        domain="[('deprecated', '=', False), ('company_id', '=', company_id), \
                    ('account_type', '=', 'asset_current'), '|', ('branch_id', '=', branch_id),('branch_id', '=', False)]")
    ...
    profit_account_id = fields.Many2one(
        ...
        domain="[('deprecated', '=', False), ('company_id', '=', company_id), \
                ('account_type', 'in', ('income', 'income_other')), '|', ('branch_id', '=', branch_id), ('branch_id', '=', False)]")
    ...
    loss_account_id = fields.Many2one(
        ...
        string='Loss Account',
        domain="[('deprecated', '=', False), ('company_id', '=', company_id), \
                ('account_type', '=', 'expense'), '|', ('branch_id', '=', branch_id), ('branch_id', '=', False)]")
