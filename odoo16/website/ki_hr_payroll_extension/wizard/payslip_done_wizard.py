...
class PayslipDoneWizard(models.TransientModel):
    _name = 'payslip.done.won.wizard'
    ...
    def action_submit(self):
        slip_ids = self.env['hr.payslip'].browse(self._context['active_ids'])
...
#             date = slip.date or slip.date_to
            ...
            slip.write({'move_id': move.id, 'date': date, 'state': 'paid'})
