...
class ReportAgedPartnerBalance(models.AbstractModel):
    _name = 'report.cue_reports.pdf_report_templates_sale'
    ...
    def get_tax_total(self, order):
        ...
        for rec in order.order_line:
            for tax in rec.tax_id:
                if tax.children_tax_ids:
                    for child_tax in tax.children_tax_ids:
                        taxes = child_tax.compute_all(rec.price_unit, rec.currency_id, rec.product_uom_qty, \
                    ...
                    taxes = tax.compute_all(rec.price_unit, rec.currency_id, rec.product_uom_qty, \
                        product=rec.product_id, partner=rec.order_id.partner_shipping_id)
    ...
    class ReportAgedPartnerBalance(models.AbstractModel):
        _name = 'report.cue_reports.pdf_report_templates_proforma'
