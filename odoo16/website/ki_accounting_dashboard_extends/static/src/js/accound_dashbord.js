    ...
    AccountingDashboard.include({
        contentTemplate: 'Invoicedashboard',
            events: _.extend({}, AccountingDashboard.prototype.events, {
				...
				'click #salary_department_details': 'click_salary_department_details',
        ...
        renderElement: function(ev) {
            ...
            console.log("_________________________  79 start_date",start_date)
            console.log("_________________________  80 end_date",end_date)
...
//                })
        ...
        click_salary_department_details: function(ev) {
            var posted = false;
            var self = this;
            var start_date = $('#start_date').val();
			var end_date = $('#end_date').val();
            ...
            rpc.query({
                model: "account.move",
                method: "click_salary_department_details",
                args: [id, start_date, end_date],
            }).then(function(result) {
                self.do_action(result);
            })
        ...
        date_apply_custom: function(ev) {
			...
			if (!end_date){
				...
				var currency = {position: 'before', symbol: '₹', language: 'en-US'}
                rpc.query({
                    model: "account.move",
                    method: "get_currency",
                }).then(function(result) {
                ...
                .then(function(result) {
                    var  sum_amount = 0.0
                     var das_table = $('#salary_details_ul')
				        das_table.empty()
				        for (var k = 0; k < result.length; k++) {
				         sum_amount += result[k]['salary'];
					}
					console.log("currency   356 ::::::",currency)

				    var  amount = self.format_currency(currency, sum_amount);
					das_table.append('<li id="salary_department_details" class= total_header_class><div  style="color:#1b1a1a;" val="' + dept_id + '"id="' + dept_id + '">' + "Total" + '</div><div  style="color:#1b1a1a;">' + amount + '</div></li>');
	                for (var k = 0; k < result.length; k++) {
                       var  amount = self.format_currency(currency, result[k]['salary']);
						...
						var dept_id = result[k]['dept_id']
                         sum_amount += result[k]['salary'];
                        das_table.append('<li><div  class="salary-line"  val="' + dept_id + '"id="' + dept_id + '">' + name + '</div><div>' + amount + '</div></li>');
...
//			    var end_date = $('#end_date').val();
               rpc.query({
                    ...
                    if (profit_this_year) {
						...
						console.log("currency   398 ::::::",currency)
...
//                                 'end_date':end_date},
						...
						console.log("currency   423 ::::::",currency)
...
//                    $('#aged_receivable').empty();
                   ...
                   das_table.empty();
					...
					console.log("currency   455 ::::::",currency)

                    var  final_amount = self.format_currency(currency, sum_amount);
                das_table.append('<li class= total_header_class><div  style="color:#1b1a1a;" val="' + final_amount + '"id="' + final_amount + '">' + "Total" + '</div><div  style="color:#1b1a1a;">' + final_amount + '</div></li>');


//                    das_table.append('<li class= total_header_class><div >' + "Total" + final_amount + '</div></li>');
//					das_table.append('<li class= total_header_class><div >' + "Total" + '</div><div>' + final_amount + '</div></li>');
//					das_table.append('<li class= total_header_class>' + "Total" +  final_amount + '</li>');


                    _.forEach(result, function(x) {
                        das_table.show();
                        due_count++;
					console.log("currency   469 ::::::",currency)

                        amount = self.format_currency(currency, x.amount);
//						$('#aged_receivable').empty();
                       das_table.append('<li class="list_class"><div id="line_' + x.parent + '" data-user-id="' + x.parent + '">' + x.due_partner + '</div>' + '<div id="line_' + x.parent + '" data-user-id="' + x.parent + '">' + amount + '</div>' + '</li>');
...
//                                 'end_date':end_date}],
                ...
                if (expense_this_year) {
					...
					console.log("currency   491 ::::::",currency)
            ...
            .then(function(result) {
                ...
                var amount_sum = 0
                 ...
                 qty_sum +=  result[k]['qty'];
					...
					console.log("currency   524 ::::::",currency)

                var  amount = self.format_currency(currency, amount_sum);
				...
				title_line_total.append('<td style="text-align:right;padding-right:5px;padding-top:4px;padding-bottom:2px;">' + amount+ '</td>')
                ...
                for (var k = 0; k < result.length; k++) {
					console.log("currency   543 ::::::",currency)
            ...
            for (var k = 0; k < result.length; k++) {
                 qty_sum +=  result[k]['qty'];
					...
					console.log("currency   577 ::::::",currency)
                               var  amount = self.format_currency(currency, amount_sum);
                ...
                for (var k = 0; k < result.length; k++) {
					console.log("currency   594 ::::::",currency)
            ...
            .then(function(result) {
                ...
                for (var k = 0; k < result.length; k++) {
                 qty_sum +=  result[k]['qty'];
					...
					console.log("currency   628 ::::::",currency)
               ...
               var  amount = self.format_currency(currency, amount_sum);
                ...
                for (var k = 0; k < result.length; k++) {
					console.log("currency   645 ::::::",currency)
...
//                })
                ...
                rpc.query({
                    ...
                    currency = result[8]
					console.log("currency   802 ::::::",currency)
                    ...
                    $('#total_customer_invoice_paid_current_month').append('<div class="logo">' + '<span>' + customer_invoice_paid_current_month + '</span><span>Total Received<span></div>');
                    ...
                    $('#total_supplier_invoice_current_month').append('<div" class="logo">' + '<span>' + supplier_invoice_total_current_month + '</span><span>Total Bills<span></div>');
                })
                var arg = 'last_month'
                var self = this;
                rpc.query({
...
//                    $('#aged_payable').empty();
					...
					console.log("currency   835 ::::::",currency)
...
//                    das_table.append('<li class= total_header_class><div >' + "Total" + '' + final_amount + '</div></li>');
                das_table.append('<li class= total_header_class><div   style="color:#1b1a1a;" val="' + final_amount + '"id="' + final_amount + '">' + "Total" + '</div><div  style="color:#1b1a1a;">' + final_amount + '</div></li>');
                    ...
                    _.forEach(result, function(x) {
                        ...
                        amount = self.format_currency(currency, x.amount);
//						$('#aged_payable').empty();
                        das_table.append('<li class="list_class"><div id="line_' + x.parent + '" data-user-id="' + x.parent + '">' + x.bill_partner + '</div>' + '<div id="line_' + x.parent + '" data-user-id="' + x.parent + '">' + amount + '</div>' + '</li>');
//                        $('#line_' + x.parent).on("click", function() {
////                            self.do_action({
////                                res_model: 'account.move',
////                                name: _t('Invoice'),
...
//                })
                ...
                rpc.query({
                    ...
                    _.forEach(result, function(x) {
                        ...
                        due_count++;
					console.log("currency   923 ::::::",currency)
                ...
                .then(function(result) {
                    ...
                    var bnk_ids = result['bank_ids'];
                      var  sum_amount = 0.0
                     var das_table = $('#current_bank_balance')
				        das_table.empty()
//                        $('#current_bank_balance').empty()
                    for (var k = 0; k < banks.length; k++) {
				         sum_amount += balance[k]
					}
					console.log("currency 957 ::::::",currency)

                    var  amount = self.format_currency(currency, sum_amount);
					das_table.append('<li class= total_header_class><div  style="color:#1b1a1a;">' + "Total" + '</div><div  style="color:#1b1a1a;">' + amount + '</div></li>');
                    for (var k = 0; k < banks.length; k++) {
                        amount = self.format_currency(currency, balance[k]);
                        das_table.append('<li><div val="' + bnk_ids[k] + '"id="b_' + bnk_ids[k] + '">' + banks[k] + '</div><div>' + amount + '</div></li>');
                ...
                rpc.query({
					...
					console.log("currency   986 ::::::",currency)
                ...
                rpc.query({
					...
					console.log("currency   1007 ::::::",currency)
                ...
                rpc.query({
					...
					console.log("currency   1045 ::::::",currency)
...
//            rpc.query({
//                model: 'account.move',
//                method: 'get_overdues_this_month_and_year_range_click',
//                args: [start_date, end_date],
//            }).then(function(result) {
//                    $('#aged_receivable').empty();
//                    var due_count = 0;
        ...
        onclick_invoice_first_quarter: function(ev) {
            ...
            rpc.query({
                ...
                $('#tot_invoice_q1').attr("max", customer_invoice_total_q1);
					console.log("currency   1881 ::::::",currency)
        ...
        onclick_invoice_second_quarter: function(ev) {
            ...
            rpc.query({
                ...
                $('#tot_invoice_q2').attr("max", customer_invoice_total_q2);
					console.log("currency   19994 ::::::",currency)
        ...
        onclick_invoice_last_quarter: function(ev) {
            ...
            rpc.query({
                ...
                $('#tot_invoice_q4').attr("max", customer_invoice_total_q4);
					console.log("currency 2217 ::::::",currency)
