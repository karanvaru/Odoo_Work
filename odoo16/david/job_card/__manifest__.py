...
""",
    ...
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/job_card/945',#'https://youtu.be/PtQnySJDBCk',
    'images': ['static/description/jobcard.jpg'],
    'category' : 'Services/Project',
    'data':[
        'security/ir.model.access.csv',
        'data/job_card_data.xml',
        'data/job_card_report_paperformat.xml',#14/03/2022
