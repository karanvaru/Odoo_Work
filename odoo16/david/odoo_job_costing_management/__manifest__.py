...
{
    'name': "Project Job Costing (Contracting) and Job Cost Sheet for Construction",
    'version': '10.9.4.22',
    'depends': [
                'sale',
                'project', #Odoo11
...
""",
    ...
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/odoo_job_costing_management/394',#'https://youtu.be/v4BSTqaDEak',
    'data':[
