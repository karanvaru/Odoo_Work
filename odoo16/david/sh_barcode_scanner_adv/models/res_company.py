...
class ResCompany(models.Model):
    ...
    sh_global_document_search_action_target_type = fields.Selection([
        ('current', 'Current'),
        ('new', 'New')
    ], default='current', string='Document Open Mode')
    ...
    sh_sale_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (sale)')
    ...
    sh_purchase_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (Purchase)')
    ...
    sh_inventory_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (Picking)')
    ...
    sh_inven_adjt_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (Inventory Adjustment)')
...
#         string='Last scanned Move To Top? (Inventory Adjustment)')
    ...
    sh_scrap_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (Scrap)')
    ...
    sh_invoice_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (Invoice)')
    ...
    sh_bom_barcode_scanner_type = fields.Selection([
        ...
        ('sh_qr_code', 'QR Code'),
        ('all', 'All'),
    ], default='barcode', string='Product Scan Options (BOM)')
