...
class VisitDetails(models.Model):
    ...
    visit_type_id = fields.Many2one('visit.type', string='Visit Type', required=True)
    company_id = fields.Many2one('res.company', string="Company")
    visited_office_id = fields.Many2one('work.office', string="Visited Office")
...
class VisitType(models.Model):
    ...
    visit_type = fields.Char(string='Name', required=True)


class WorkOffice(models.Model):
    _name = 'work.office'
    _description = "Work Office"
    _rec_name = 'work_office'

    work_office = fields.Char(string='Name', required=True)


class VisitPurpose(models.Model):
    _name = 'fo.purpose'
    _description = "FO Purpose"
