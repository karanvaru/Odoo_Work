...
class ir_attachment(models.Model):
    ...
    def _filter_non_synced_attachments(self):
        ...
        for attachment in self:
            not_sync = (
                attachment.mimetype in mime_types.values() and not attachment.res_model
    ...
    def _update_folders(self):
        ...
        self._cr.commit()
        # 2
        to_sync_models = sync_model_obj.browse(to_sync_model_ids)
        ...
        for sync_model in to_sync_models:
            ...
            domain = safe_eval(sync_model.domain)
