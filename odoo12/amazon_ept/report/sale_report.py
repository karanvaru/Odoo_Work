...
class sale_report(models.Model):
    ...
    amz_instance_id = fields.Many2one("amazon.instance.ept", "Instance", readonly=True)
        ...
        select_str = """
            WITH currency_rate as (%s)
             SELECT min(l.id) as id,
                    ...
                    s.amz_fulfillment_by as amz_fulfillment_by,                    
                    p.product_tmpl_id,
                    partner.country_id as country_id,
                    s.amz_instance_id as amz_instance_id,
    ...
    def _from(self):
        from_str = """
                sale_order_line l
                      ...
                      join amazon_instance_ept on amazon_instance_ept.id=s.amz_instance_id              
