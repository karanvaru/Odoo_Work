...
class account_fiscal_position(models.Model):
    ...
    origin_country_ept = fields.Many2one('res.country', string='Origin Country', help="Use Of this field to search fiscal position based on warehouse country")


    """ 
    Override this method to search fiscal position based on Odoo default rule and Origin warehouse.
    In based on if not any fiscal position found then select default 1.
    We have to avoid due to that reason override method
    """
    @api.model
