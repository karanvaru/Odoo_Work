...
function isValidEmailAddress(emailAddress) {
    ...
    $("#join-btn").click(function(){
      ...
      if (isValidEmailAddress(email)){
          $('.affiliate_loader').css("display","block");
                ...
                $(".aff_box").replaceWith(
                  "<div class='alert_msg_banner_signup' style='margin-top:10px;'> \
                    ...
                    <div style="color:white; padding:5px 10px;">\
                     <i class="fa fa-check-circle"/> &nbsp;<span>"+result+"</span>\
                    </div>\
                 ...
                 <div id='aff_req_btn'>\
                    <center>\
                      <a href='/shop'  class="btn-black">Continue Shopping</a>\
                   </center>\
                 </div>");
            }
            $('.affiliate_loader').css("display","none");
          });
