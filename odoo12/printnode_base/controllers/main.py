...
class DataSetProxy(DataSet):
    ...
    def _call_kw(self, model, method, args, kwargs):
        ...
        context_, ar_, kw_ = api.split_context(method_, args_, kwargs_)
...
class ReportControllerProxy(ReportController):
    ...
    def report_print(self, data, context=None):
        ...
        standard_response = self.report_download(data, 'fake-token')
        ...
        return json.dumps({
            ...
            'message': message,
            'success': True,
            'notify': request.env.user.company_id.im_a_teapot
        })
