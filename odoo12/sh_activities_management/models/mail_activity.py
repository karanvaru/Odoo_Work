...
class MailActivity(models.Model):
    ...
    def action_feedback(self, feedback=False):
        return super(MailActivity, self.with_context(from_feedback=True)).action_feedback(feedback)            
                
    @api.multi
    def unlink(self):
        for activity in self:
            if self._context.get("from_feedback", False):
